...
const field = "h-12 rounded-xl px-4 bg-card border border-border/60 text-foreground placeholder:text-muted-foreground focus-visible:ring-primary/50 focus-visible:border-primary/60";
...
export default function AuthPage() {
  ...
  return (
    <div className="relative min-h-dvh overflow-hidden">
      <div className="pointer-events-none absolute -top-32 -left-16 h-64 w-64 rounded-full bg-primary/15 blur-3xl" />
          ...
          <div className="mt-10 animate-fade-up">
            ...
            <div className="mt-6 space-y-4">
              ...
              <Button
                onClick={doSignIn}
                disabled={busy}
                className="w-full h-12 rounded-xl text-sm font-semibold gradient-primary shadow-float"
              >
