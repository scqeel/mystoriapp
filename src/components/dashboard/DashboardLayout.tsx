...
export function DashboardLayout({
  ...
  return (
    <AppShell>
      <div className="mx-auto w-full max-w-[1540px] px-4 py-5 md:px-6 xl:px-8">
        <div className="mb-5 flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
          ...
          <div className="flex w-full items-center gap-2 xl:w-auto">
            ...
            <button className="inline-flex h-11 w-11 items-center justify-center rounded-2xl border border-border/60 bg-card/70 text-muted-foreground transition-colors hover:text-foreground">
        ...
        <div className="grid gap-4 lg:grid-cols-12 xl:gap-5">
          <aside className="self-start rounded-3xl border border-border/60 bg-sidebar/90 p-3 shadow-float backdrop-blur-sm lg:sticky lg:top-5 lg:col-span-3 xl:col-span-2">
